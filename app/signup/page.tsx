                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-2">
                            ...
                            <button
                                onClick={() => {
                                    if (phone.length != 10 || !(/^\d+$/.test(phone))) toast.error('Invalid Phone Number')
                                    else {
                                        sendOtp();
                                        setViewOtpBar(true);
                                    };
                        ...
                        </div>
                        {
                            viewOtpBar ?
                                <div className='flex flex-col sm:flex-row justify-between items-center gap-2 my-1'>
                                    <input
                                        placeholder={'Enter the otp send on the xxx' + phone.substring(phone.length - 4, phone.length)}
                    ...
                    <div className='flex flex-col sm:flex-row justify-between gap-2'>
                        ...
                        <Link className="w-full sm:w-20 bg-green-600 text-white py-2 rounded-md hover:bg-green-700 transition-all duration-300 text-center" href="/login">Login?</Link>
                    </div>
                </form>
            </div>
        </div>
